...
def library_materials(closed_loop):
    ...
    second_run = seed_run(learner.learner_id, first.material_id, first.artifact_id, "second-version", settings, dsn=dsn)
    ...
    failed = seed_run(learner.learner_id, first.material_id, first.artifact_id, "new-failed-attempt", settings, dsn=dsn)
    with psycopg.connect(dsn) as connection:
    ...
    running_run = seed_run(learner.learner_id, running.material_id, running.artifact_id, "running", settings, dsn=dsn)
