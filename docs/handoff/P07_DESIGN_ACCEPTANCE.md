...
| Processing | General UI Processing Loading | `material-processing-run/v3`: persisted stage and page progress | 1448×1086 | Pass | Reviewed | `aria-live`; reduced motion | Stage timeline and persisted page counts are shown when available; other stages remain indeterminate, with no ETA or semantic-quality claim | `03_processing.png` |
